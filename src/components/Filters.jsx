...
const Filters = () => {
  return (
    <aside className=" w-1/4 space-y-8 hidden lg:flex flex-col">
        ...
        <div className="">
            <div className="flex justify-between">
                <h2 className='text-lg uppercase font-semibold tracking-wider'>Categories</h2>
            ...
            <div className="mt-5 space-y-4 capitalize tracking-wider text-gray-500">
                ...
                <input type="checkbox" className='h-5 w-5 rounded  text-[#48c4a0] focus:ring-0' />
        ...
        <div className="">
            <div className="flex justify-between">
                <h2 className='text-lg uppercase font-semibold tracking-wider'>Price</h2>
            </div>
            <hr className='mt-2' />
        ...
        <div className="">
            <div className="flex justify-between">
                <h2 className='text-lg uppercase font-semibold tracking-wider'>colors</h2>
                 <BiSearch className='w-6 h-6'/> 
            </div>
            <hr className='mt-2' />
