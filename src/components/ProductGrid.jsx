  ...
  return (
    <section className="container mx-auto gap-10 px-5 xl:px-28 grid grid-cols-1 md:grid-cols-3 capitalize place-items-center mt-20 ">
      ...
      <div className=" md:space-y-4 w-full ">
        <h2 className="font-bold uppercase tracking-widest">Bestseller</h2>
        <hr />
      ...
      {/* New Arrival */}
      <div className=" md:space-y-4 w-full ">
        <h2 className="font-bold uppercase tracking-widest">New arrival</h2>
        <hr />
      ...
      {/* Featured */}
      <div className=" md:space-y-4 w-full ">
        <h2 className="font-bold uppercase tracking-widest">Featured</h2>
        <hr />
