    ...
    return (
        ...
        <footer className="bg-[#48c4a0] container mx-auto mt-36 grid-cols-1 space-y-10 md:space-y-0 grid md:grid-cols-4 px-5 xl:px-28 text-white tracking-wider py-8 xl:py-20">
            ...
            <div className="space-y-6">
                ...
                <p className='text-sm w-2/3 font-light'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Enim, voluptas!</p>
            </div>
            {/* Grid 2 */}
            <div className="space-y-6">
            ...
            <div className="space-y-1">
                ...
                <div className="flex flex-col space-y-3 font-light ">
                    ...
                    <div className="flex justify-center items-center space-x-4 ">
                        <img src={ProductImage1} alt="" className='w-20 h-12 object-cover object-center' />
                        <div className="space-y-1">
                    ...
                    <div className="flex justify-center items-center space-x-4">
                        <img src={ProductImage2} alt="" className='w-20 h-12 object-cover object-center' />
                        <div className="space-y-1">
                            <h2>Furniture Decoration idea</h2>
                            <p className='text-xs text-gray-200'>October 20, 2014</p>
                        </div>
                    ...
                    <div className="flex justify-center items-center space-x-4">
                        <img src={ProductImage3} alt="" className='w-20 h-12 object-cover object-center' />
                        <div className="space-y-1">
                            <h2>Furniture Decoration idea</h2>
                            <p className='text-xs text-gray-200'>October 20, 2014</p>
                        </div>
